  ...
  return (
    <div>
      <div className="navbar">
        <h1>Legal<span style={{ color: 'blue' }}>Advisor</span></h1>
        
        <p class="d-inline-flex gap-1">
       
        <a href="http://127.0.0.1:8000/chat" class="btn btn-primary active" role="button" data-bs-toggle="button" aria-pressed="true">Back</a>
